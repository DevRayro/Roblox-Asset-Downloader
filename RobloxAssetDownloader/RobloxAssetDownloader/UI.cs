...
namespace RobloxAssetDownloader {
    public partial class UI : Form {
        ...
        private void TextFocus(object sender, EventArgs e) {
            ...
            if (URLBox.Text == "Enter asset id...") URLBox.Text = "";
        ...
        private void overlayText_Click(object sender, EventArgs e)
        {

        }

        private void templateOverlayBg_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void noOverlay_CheckedChanged(object sender, EventArgs e)
        {
